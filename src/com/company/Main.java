...
public class Main {
    static String playrName1 = "Player#1";
    static String playrName2 = "Player#2";
    ...
    public static void main(String[] args) {
        ...
        playrName1 = scanner.nextLine();
        System.out.println("Player#2, please enter your name: ");
        playrName2 = scanner.nextLine();

        placeShips(playrName1, battlefield1);
        placeShips(playrName2, battlefield2);
        while (true) {
            makeTurn(playrName1, monitor1, battlefield2);
            if (isWinCondition()) {
                break;
            }
            makeTurn(playrName2, monitor2, battlefield1);
            if (isWinCondition()) {
                break;
            }
        }
    ...
    public static void placeShips(String playerName, int[][] battlefield) {
        ...
        while (deck >= 1) {
            ...
            System.out.println();
            System.out.println(playerName + ", please place your " + deck + "-deck ship on the battleships: ");
            System.out.println();
    ...
    public static void drawField(int[][] battlefield) {
        System.out.println("  А Б В Г Д Е Ж И К Л");
    ...
    public static boolean isWinCondition() {
        ...
        if (counter1 >= 10) {
            System.out.println(playrName1 + " Win!!!");
            return true;
        }
        if (counter2 >= 10) {
            System.out.println(playrName2 + " Win!!!");
            return true;
        }
        return false;
    }
